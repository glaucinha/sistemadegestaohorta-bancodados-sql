...
CREATE TABLE DOACAO (
  IDdoacaoinstituicao INt unsigned auto_increment primary key,
  iddoacao INT,
  ID_INSTITUICAO int,
  data_entrega DATE,
  QUANT_ENTREGE DECIMAL(10,2)
  RESPONSAVEL_ ENTREGA VARCAHR(100)
  OBSERVACOES text,
  FOREIGN KEY (IDDOACAO) REFERENCES DOACAO(IDDOACAO)
  FOREING KEY (IDINSTITUICAO)  REFERENCES INSTITUICAO(IDINSTITUICAO) 
  );
